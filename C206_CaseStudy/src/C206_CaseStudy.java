...
public class C206_CaseStudy {
	 ...
	 * doLoanCamcorder(ArrayList<Camcorder> camcorderList, String tag, String
	 * dueDate) {
	 * 
	 * boolean isLoaned = false;
	 * 
	 * if (tag.isEmpty() || dueDate.isEmpty()) return false;
	 * 
	 ...
	 * Helper.readString("Enter asset tag > "); String due =
	 * Helper.readString("Enter due date > "); Boolean isLoaned =
	 * doLoanCamcorder(camcorderList, tag, due); if (isLoaned == false) {
	 * System.out.println("Invalid asset tag"); } else {
	 * System.out.println("Camcorder " + tag + " loaned out"); } }
	 * 
	 * public static boolean doLoanChromebook(ArrayList<Chromebook> chromebookList,
	 * String tag, String dueDate) { // write your code here boolean isLoaned =
	 * false;
	 * 
	 * if (tag.isEmpty() || dueDate.isEmpty()) return false;
	 * 
	 ...
	 * write your code here C206_CaseStudy.viewAllChromebook(chromebookList); String
	 * tag = Helper.readString("Enter asset tag > "); String due =
	 * Helper.readString("Enter due date > "); Boolean isLoaned =
	 * doLoanChromebook(chromebookList, tag, due); if (isLoaned == false) {
	 * System.out.println("Invalid asset tag"); } else {
