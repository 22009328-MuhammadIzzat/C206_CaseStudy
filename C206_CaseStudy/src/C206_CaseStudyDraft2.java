...
public class C206_CaseStudyDraft2 {
		...
		public static void main(String[] args) {
			...
			while (option != 5) {
				...
				C206_CaseStudyDraft2.mainMenu();
				option = Helper.readInt("Enter an option > ");

				if (option == 1) { // administrator
					C206_CaseStudyDraft2.administratorMenu();
					int adOption = Helper.readInt("Choose 1 option: ");

					if (adOption == 1) { // schoolManagement
						C206_CaseStudyDraft2.schoolManagementMenu();
						...
						if (schOption == 1) {
							// Add a school
							C206_CaseStudyDraft2.addSchool(SchoolList, C206_CaseStudy.inputSchool());
							System.out.println("School added");

						} else if (schOption == 2) {
							// View all schools
							C206_CaseStudyDraft2.viewAllSchool(SchoolList);

						} else if (schOption == 3) {
							// Delete a school
							String nameOfSchooltoDelete = Helper.readString("Enter School Name to delete: ");
							C206_CaseStudyDraft2.deleteSchoolByName(SchoolList, nameOfSchooltoDelete);
						...
						C206_CaseStudyDraft2.userManagementMenu();
						...
						C206_CaseStudyDraft2.vendorManagementMenu();
						...
						if (vendorOption == 1) {
							...
							C206_CaseStudyDraft2.addVendor(VendorList, vendorToBeAdded);
							System.out.println("Vendor successfully added");

						} else if (vendorOption == 2) {
							// View all vendors
							C206_CaseStudyDraft2.viewAllVendor(VendorList);

						} else if (vendorOption == 3) {
							// Delete a vendor
							String vendorName = Helper.readString("Enter Vendor Name To Delete: ");
							C206_CaseStudyDraft2.deleteVendorByName(VendorList, vendorName);
				...
				if (option == 2) { // user
					...
					if (userOption == 1) {
						...
						C206_CaseStudyDraft2.orderManagementMenu();
						...
						C206_CaseStudyDraft2.paymentManagementMenu();
					...
					C206_CaseStudyDraft2.menusManagementMenu();
					int vendorOption = Helper.readInt("Choose 1 option: ");
					while (vendorOption < 1 || vendorOption > 3) {
						System.out.println("Invalid Option! Please try again.");
						vendorOption = Helper.readInt("Choose 1 Option: ");
					...
					if (vendorOption == 1) {
						...
						C206_CaseStudyDraft2.addVendorMenu(MenuList, menuToBeAdded);
						System.out.println("Menu added successfully!");
					} else if (vendorOption == 2) {
						// View menu
						C206_CaseStudyDraft2.viewAllVendorMenu(MenuList);
					} else if (vendorOption == 3) {
						// Delete menu
						String name = Helper.readString("Enter menu name to delete: ");
						C206_CaseStudyDraft2.deleteVendorMenuByName(MenuList, name);
						System.out.println("Vendor successfully deleted");
		...
		public static void viewAllUsers(ArrayList<Users> usersList) {
			C206_CaseStudyDraft2.setHeader("USER LIST");
		...
		public static void addVendorMenu(ArrayList<VendorMenu> menuList, VendorMenu menuToBeAdded) {
			...
			for(VendorMenu existingMenu : menuList) {
				if (existingMenu.getMenuName().equalsIgnoreCase(newMenuName)) {
					System.out.println("Menu " + newMenuName + " already exists. Duplicate names are not allowed.");
					return;
				}
		...
		public static void viewAllVendorMenu(ArrayList<VendorMenu> menuList) {
			// TODO Auto-generated method stub
			C206_CaseStudyDraft2.setHeader("MENU LIST");
		...
		public static void addVendor(ArrayList<Vendor> VendorList, Vendor newVendor) {
			...
			public static void viewAllVendor(ArrayList<Vendor> VendorList) {
				C206_CaseStudyDraft2.setHeader("VENDORS LIST");
